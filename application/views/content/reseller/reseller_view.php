<body>
    ...
    <div class="container-fluid mt-5">
        ...
        <table class="table table-hover ">
            <thead class="sticky-top" style="margin-bottom: 20px;">
                <tr>
                    <th class="col-3">
                    ...
                    <th class="col-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <span>Email</span>
                            <button class="btn btn-link sort-btn-sml" data-sort="email">
                                <i class="fas fa-sort"></i>
                            </button>
                        </div>
                    </th>
                    <th class="col-1">
                        <div class="d-flex justify-content-between align-items-center">
                            <span>Plafon</span>
                            <button class="btn btn-link sort-btn-sml" data-sort="plafon">
                                <i class="fas fa-sort"></i>
                            </button>
                        </div>
                    </th>
