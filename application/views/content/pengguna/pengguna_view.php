<body>
    ...
    <div class="container-fluid mt-5">
        ...
        <br>
            <div class="table-responsive" style="background-color:#F7F6FE">
            ...
            <thead class="sticky-top">
                <tr>
                    ...
                    <th class="col-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span>Username</span>
                            <button class="btn btn-link sort-btn-sml" data-sort="username">
                                <i class="fas fa-sort"></i>
                            </button>
                    </th>
                    <th class="col-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span>Password</span>
                            <button class="btn btn-link sort-btn-sml" data-sort="pass">
                                <i class="fas fa-sort"></i>
                            </button>
                    </th>
                    <th class="col-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <span>Role</span>
                            <button class="btn btn-link sort-btn-sml" data-sort="role">
                                <i class="fas fa-sort"></i>
                            </button>
                    </th>
