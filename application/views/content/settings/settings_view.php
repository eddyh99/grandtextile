       <div class="container-fluid mt-5">
            <div class="d-flex justify-content-end">
                <a href="<?php echo site_url('settings/addsettings'); ?>" class="btn btn-primary" style="background-color: #624DE3;">
    ...
    <div class="container-fluid">
        <div class="table">
            <table id="settingsTable" class="table table-hover table-striped">
                ...
                <tbody>
                    <?php foreach ($settings_data as $index => $row): ?>
                        <tr class="mt-1">
                            <td>
                                <?php echo $row['margin']; ?>
                            </td>
                            ...
                            <td class="text-right">
                                <a href="<?= site_url('settings/editsettings'); ?>" class="btn btn-link p-0">
