<div class="container-fluid mt-5" style:"">
    <div class="d-flex justify-content-end mb-3">
        <a href="<?php echo site_url('proses/addproses'); ?>" class="btn btn-primary" style="background-color: #624DE3;">
 ...
 <div class="container-fluid">
     <table id="prosesTable" class="table table-hover table-striped">
            ...
            <tbody style="margin-top: 20px;">
                <?php foreach ($proses_data as $index => $row): ?>
                    <tr class="mt-1">
                        <td>
                            <?php echo $row['nama']; ?>
                        </td>
                        ...
                        <td class="text-right">
                            <a href="<?= site_url('proses/editproses/'); ?>" class="btn btn-link p-0">
                                <img src="<?= base_url('assets/img/edit.png'); ?>" alt="edit" class="img-fluid" />
                            </a>
                            <button
                                type="button"
                                class="btn btn-link p-0 delete-proses-button"
                                data-bs-toggle="modal"
                                data-bs-target="#myModal"
                                data-tgl="<?= $row['tgl'] ?>"
                                data-nama="<?= $row['nama']?>"
                                data-href="<?= site_url('proses/deleteproses/') . $row['tgl'] ?>"
                            >
